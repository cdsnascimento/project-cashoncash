...
export const Card = (props: CardProps) => {
  return (
    <>
      <div className="h-80 card shadow-sm p-3 mb-5 bg-body rounded">
        <svg className="card-img-top h-50" version="1.0" xmlns="http://www.w3.org/2000/svg"
